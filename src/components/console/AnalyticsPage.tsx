      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600">Confirmation Rate</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600">Avg Players/Booking</p>
            ...
            {analytics.topCourse ? (
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">{analytics.topCourse.name}</p>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-slate-700">Active Organizations</span>
              ...
              <div className="pt-2 border-t border-slate-200">
                <p className="text-xs text-slate-600">Average quota utilization</p>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                ...
                <span className="text-xl font-bold text-green-600">12 min</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Fulfillment Rate</p>
                    <p className="text-xs text-slate-600">Last 30 days</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg border border-amber-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Satisfaction Score</p>
                    <p className="text-xs text-slate-600">Member feedback</p>
                  </div>
                </div>
                <span className="text-xl font-bold text-amber-600">4.8/5.0</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-3 bg-slate-50 rounded-lg">
                <p className="text-xs text-slate-600 mb-1">Today's Bookings</p>
